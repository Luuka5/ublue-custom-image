export image_name := env("IMAGE_NAME", "toucode-bootc-base") # output image name, usually same as repo name, change as needed
...
build user="touko" $target_image=image_name $tag=default_tag:
    #!/usr/bin/env bash
